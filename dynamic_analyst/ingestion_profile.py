...
ENTITY_HINTS = {
    "crash": ["crash", "accident", "collision", "incident", "severity"],
...
FIELD_HINTS = {
    "primary_id": ["crash_id", "incident_id", "event_id", "record", "uuid", "image", "image_no", "id"],
    "timestamp": ["timestamp", "datetime", "date_time", "event_datetime"],
    "event_date": ["event_date", "accident_date", "crash_date", "date"],
    "event_time": ["event_time", "accident_time", "crash_time", "time"],
    ...
    "road_id": ["road_segment_id", "segment_id", "road_id", "trf_info_seg_id", "travelway_id"],
}
